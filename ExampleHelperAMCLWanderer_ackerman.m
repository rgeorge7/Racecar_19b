classdef ExampleHelperAMCLWanderer_ackerman
...
% Copyright 2015-2018 The MathWorks, Inc.
    ...
    methods
        function obj = ExampleHelperAMCLWanderer_ackerman(laserSub, tf, velPub, velMsg)
        ...
        % Initialize sensor interface
            ...
            % Initialize controllerVFH object. The parameters here
    ...
    methods (Access = private)
        ...
        %ros publisher
            obj.VelocityMessage.Drive.Speed = v;
            obj.VelocityMessage.Drive.SteeringAngle = w;
